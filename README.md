...
1. What is the DOM?
Document Object Model, a program interface for HTML that can be altered with javascript.

2. What is an event?
Events are what a user does with an application, clicking, typing, etc.
